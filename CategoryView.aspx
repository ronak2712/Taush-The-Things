<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CategoryView.aspx.cs" Inherits="Default3" %>
                                ...
                                <div class="isotope-item  newproducts discount">
                                    <div class="product-item hvr-underline-from-center">
                                        <div class="product-item_body">
                                          <asp:Image ID="Image1" CssClass="product-item_image"  Height="247px" Width="250px" runat="server" ImageUrl='<%# Eval("Img1") %>' />
                                            ...
                                            <div class="product-sidebar">
                                                ...
                                                <p class="fa fa-location-arrow">
                                                    <span><asp:Label ID="AidLabel" runat="server" Text='<%# Eval("CName") %>' /></span>
                                                </p>
